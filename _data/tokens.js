...
window.BAKLAVA_TOKENS = {
  ...
  "preview/foundations-selection-skeleton.html": [
    ...
    { name: "--color-selection-text", value: "#0F172A", role: "Text-highlight foreground — Grey-900" },
  ...
  "preview/colors-all-ramps.html": [
    ...
    { name: "--bk-indigo-600", value: "#474DE8", role: "Information" },
  ...
  "preview/colors-semantic-text.html": [
    { name: "--color-text-body",          value: "#0F172A", role: "Default body text — Grey-900" },
    { name: "--color-text-heading",       value: "#0F172A", role: "Headings — Grey-900" },
    ...
    { name: "--color-text-information",   value: "#393AC2", role: "Informational accent — Indigo-700" },
    ...
    { name: "--color-text-accent-indigo", value: "#474DE8", role: "Accent text · indigo — Indigo-600" },
  ...
  "preview/colors-surfaces.html": [
    ...
    { name: "--color-surface-navbar",  value: "#081A4D", role: "Global navbar (Blue-1000)" },
  ...
  "preview/components-inputs.html": [
    ...
    { name: "--field-text-default",     value: "#0F172A",  role: "Typed value — Grey-900" },
  ...
  "preview/components-table.html": [
    ...
    { name: "--color-text-body",            value: "#0F172A", role: "Header label + cell text (Grey-900)" },
  ...
  "preview/components-global-header.html": [
    { name: "--color-surface-navbar", value: "#081A4D", role: "Global navbar background — Blue-1000" },
