...
window.BAKLAVA_TOKENS = {
  ...
  "preview/foundations-selection-skeleton.html": [
    ...
    { name: "--color-selection-text", value: "#081A4D", role: "Text-highlight foreground — Indigo-900" },
  ...
  "preview/colors-all-ramps.html": [
    ...
    { name: "--bk-teal-600",   value: "#0094B8", role: "Focus ring & cool accent" },
    { name: "--bk-indigo-600", value: "#1749E8", role: "Information" },
    { name: "--bk-orange-600", value: "#F9660B", role: "Accent" },
    { name: "--bk-yellow-600", value: "#FBBC04", role: "Warning" },
    { name: "--bk-purple-600", value: "#8B5CF6", role: "Discovery" },
    { name: "--bk-green-600",  value: "#017D1B", role: "Success" },
    { name: "--bk-red-600",    value: "#E31C3D", role: "Alert / destructive" },
    { name: "--bk-pink-600",   value: "#FF2D8F", role: "Marketing accent" },
    { name: "--bk-grey-600",   value: "#475569", role: "Neutral" },
  ],
  "preview/colors-semantic-text.html": [
    { name: "--color-text-body",          value: "#081A4D", role: "Default body text — Indigo-900" },
    { name: "--color-text-heading",       value: "#081A4D", role: "Headings — Indigo-900" },
    ...
    { name: "--color-text-link-hover",    value: "#0094B8", role: "Link hover — Teal-600" },
    { name: "--color-text-link-pressed",  value: "#22D3EE", role: "Link pressed — Teal-400" },
    ...
    { name: "--color-text-information",   value: "#1237C0", role: "Informational accent — Indigo-700" },
    { name: "--color-text-discovery",     value: "#7644EA", role: "Discovery accent — Purple-700" },
    { name: "--color-text-accent-blue",   value: "#2563FF", role: "Accent text · blue — Blue-600" },
    { name: "--color-text-accent-teal",   value: "#0094B8", role: "Accent text · teal — Teal-600" },
    { name: "--color-text-accent-indigo", value: "#1749E8", role: "Accent text · indigo — Indigo-600" },
    ...
    { name: "--color-text-accent-purple", value: "#8B5CF6", role: "Accent text · purple — Purple-600" },
    ...
    { name: "--color-text-accent-pink",   value: "#FF2D8F", role: "Accent text · pink — Pink-600" },
  ...
  "preview/colors-surfaces.html": [
    ...
    { name: "--color-surface-navbar",  value: "#0B246E", role: "Global navbar (Indigo-1000)" },
  ...
  "preview/components-buttons.html": [
    ...
    { name: "--color-background-primary-pressed", value: "#22D3EE", role: "Primary pressed — Teal-400" },
  ...
  "preview/components-inputs.html": [
    ...
    { name: "--field-border-focus",     value: "#0094B8",  role: "Focus border — Teal-600" },
    ...
    { name: "--field-text-default",     value: "#081A4D",  role: "Typed value — Indigo-900" },
  ...
  "preview/components-badges.html": [
    ...
    { name: "--bk-purple-100",        value: "#F7F2FF", role: "Discovery badge fill" },
  ],
  ...
  "preview/components-table.html": [
    ...
    { name: "--color-text-body",            value: "#0B246E", role: "Header label + cell text (Indigo-900)" },
  ...
  "preview/components-global-header.html": [
    { name: "--color-surface-navbar", value: "#0B246E", role: "Global navbar background — Indigo-1000" },
